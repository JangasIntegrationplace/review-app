...
import { SignUpAPI, AuthBO } from '../../../adapters/xhr/auth';
...
export const SignUp = (props) => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      const responseObj = await SignUpAPI.post(authBO);
  ...
  return (
    <React.Fragment>
      ...
      <Typography variant="caption" color="error" display="block" gutterBottom>
        It's a platform for NanoGiants Hackathon and will be deleted by end of September.
      </Typography>
      <form
